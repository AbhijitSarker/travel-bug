...
const Header = () => {
    ...
    return (
        ...
        <nav className='navbar-items z-10 md:sticky top-3 bg-white rounded-md p-2 flex justify-between items-center shadow-lg container mx-auto mt-3'>
            ...
            <div className={`bg-white opacity-80 grid absolute px-10 pt-20 md:pt-0 md:px-0 pb-5 md:pb-0 mt-3 md:mt-0 rounded-md gap-3 md:gap-0 md:static md:ml-auto  text-center  md:flex font-bold items-center whitespace-nowrap duration-700 ease-in-out  ${open === true ? 'top-0 left-0 right-0' : '-top-full left-0 right-0'}`}>
